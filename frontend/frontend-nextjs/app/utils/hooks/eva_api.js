...
export const getVideosSearch = ({page=1, page_limit=5, query=null, filter_params} = {}) => instance.get(`videos/search`, {params: {page, page_limit, query, filter_params}}).then((response) => response.data);
export const getClipsSearch = ({page=1, page_limit=5, query=null, filter_params} = {}) => instance.get(`clips/search`, {params: {page, page_limit, query, filter_params}}).then((response) => response.data);   
